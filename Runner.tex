...
The Linux Hierarchy Standard (LHS)~\cite{lsb2015fhs} defines support for
...
difficults the maintenance of fundamental system services~\cite{heen2005thesis}.
...
The virtual filesystem is implemented as a FUSE daemon~\cite{miklos2001fuse} that
