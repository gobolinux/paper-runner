...
Put it simply, if a program depends on a given library `/usr/lib/lib\-foo.so` and it
...
Again, if a program depends on a given library `/usr/lib/lib\-foo.so` and it
