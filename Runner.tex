...
to execute the software, along with other information. It is also possible to run the program
in a confined sandbox enforced by AppArmor, a Linux kernel security module. At runtime, Snap
creates a writable area through 
